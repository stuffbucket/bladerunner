...
| Concept | What it is |
|---|---|
| **The MACHINE** | The long-lived bladerunner Incus VM (`br start`). The drive. You rarely pass a whole machine — that is the rare heavy #72 cartridge. |
...
- **Sealed cartridge case** (host file lock, `chflags uchg`): the DMG file itself cannot be modified or deleted on the host.
